...
void onKeyDown(unsigned char key, int x, int y) {
	...
	case 's':
		...
		break;
	case 'a':
		t1->translate(-0.05f, 0.0f, 0.0f);
		break;
	case 'd':
		t1->translate(0.05f, 0.0f, 0.0f);
		break;
	case 'v':
		t1->translate(0.0f, 0.0f, 0.05f);
		break;
	case 'b':
		t1->translate(0.0f, 0.0f, -0.05f);
		break;
	...
	case 'q':
		t1->uniformScale(0.01f);
		break;
	case 'e':
		t1->uniformScale(-0.01f);
		break;

	// non-uniform scale up + down
	case 'z':
		t1->nonUniformScale(0.05f, 0.02f, 0.01f);
		break;
	case 'c':
		t1->nonUniformScale(-0.05f, -0.02f, -0.01f);
		break;
